...
public record SyncVoltageTiersMessage(long generation, List<VoltageTierDisplay> tiers) {
    ...
    public static void encode(SyncVoltageTiersMessage message, FriendlyByteBuf buffer) {
    ...
    public static SyncVoltageTiersMessage decode(FriendlyByteBuf buffer) {
