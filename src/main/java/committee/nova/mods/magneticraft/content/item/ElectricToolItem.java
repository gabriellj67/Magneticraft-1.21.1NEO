...
public abstract class ElectricToolItem extends PortableEnergyItem {
    ...
    public boolean mineBlock(
        ...
        boolean creativePlayer = miner instanceof Player player && player.getAbilities().instabuild;
    ...
    public boolean isCorrectToolForDrops(BlockState state) {
        return isEffectiveBlock(state) && TierSortingRegistry.isCorrectTierForDrops(Tiers.DIAMOND, state);
    }
