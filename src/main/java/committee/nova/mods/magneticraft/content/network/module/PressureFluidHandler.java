...
/**
 * Whole-millibucket Forge fluid view over the authoritative pressure node.
 */
public final class PressureFluidHandler implements IFluidHandler {
    ...
    public FluidStack getFluidInTank(int tank) {
        ...
        Fluid fluid = gasId == null ? Fluids.EMPTY : ForgeRegistries.FLUIDS.getValue(gasId);
    ...
    public int fill(FluidStack resource, FluidAction action) {
        ...
        ResourceLocation gasId = ForgeRegistries.FLUIDS.getKey(resource.getFluid());
    ...
    public FluidStack drain(FluidStack resource, FluidAction action) {
        ...
        ResourceLocation requested = ForgeRegistries.FLUIDS.getKey(resource.getFluid());
