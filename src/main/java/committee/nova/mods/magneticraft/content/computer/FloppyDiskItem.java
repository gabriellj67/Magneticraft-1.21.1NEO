...
public final class FloppyDiskItem extends Item {
    ...
    public static boolean storeProgram(ItemStack stack, List<ComputerInstruction> program) {
        ...
        CustomData.update(DataComponents.CUSTOM_DATA, stack, tag -> FloppyDiskPersistence.writeLegacy(tag, program));
        return true;
    }
    ...
    public static boolean storeScript(ItemStack stack, ScriptProgram program, Optional<VirtualDisk> disk) {
        ...
        CustomData.update(DataComponents.CUSTOM_DATA, stack, tag -> FloppyDiskPersistence.writeScript(tag, program, disk));
        return true;
    }
    ...
    static Optional<FloppyDiskPersistence.State> readState(ItemStack stack) {
        ...
        return data == null ? Optional.of(FloppyDiskPersistence.State.empty()) : FloppyDiskPersistence.read(data.copyTag());
    }
    ...
    public static void configurePreset(ItemStack stack, String preset, @Nullable ScriptLanguage language) {
        CustomData.update(DataComponents.CUSTOM_DATA, stack, tag -> FloppyDiskPersistence.writePreset(tag, preset, language));
    }
