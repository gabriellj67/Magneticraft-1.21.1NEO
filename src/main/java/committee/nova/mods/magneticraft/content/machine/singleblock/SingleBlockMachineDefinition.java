...
public enum SingleBlockMachineDefinition {
    BOX("box", "Box", "木箱", 27, 0, true, FacingMode.NONE, false),
    ...
    RELAY("relay", "Relay", "中继器", 9, 0, true, FacingMode.ALL, false),
    FILTER("filter", "Pneumatic Filter", "气动过滤器", 1, 9, true, FacingMode.ALL, false),
    TRANSPOSER("transposer", "Transposer", "转置器", 0, 9, true, FacingMode.ALL, false),
    ...
    RF_HEATER("rf_heater", "FE Heater", "FE 加热器", 0, 0, true, FacingMode.NONE, false),
    ...
    INFINITE_ENERGY("infinite_energy", "Infinite Energy", "无限电源", 0, 0, false, FacingMode.NONE, false),
    ...
    RF_TRANSFORMER("rf_transformer", "FE Transformer", "FE 变压器", 0, 0, true, FacingMode.NONE, false),
