...
public enum SingleBlockMachineDefinition {
    ...
    TRANSPOSER("pneumatic_transposer", "Pneumatic Transposer", "气动物品转运器", 0, 9, true, FacingMode.ALL, false),
    ...
    RF_HEATER("forge_energy_heater", "Forge Energy Heater", "FE 加热器", 0, 0, true, FacingMode.NONE, false),
    ...
    INFINITE_ENERGY("infinite_energy_source", "Infinite Energy Source", "创造模式电源", 0, 0, false, FacingMode.NONE, false),
