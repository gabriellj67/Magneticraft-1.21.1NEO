...
public enum BaseBlockDefinition {
    ...
    COBBLED_LIMESTONE("cobbled_limestone", "Cobbled Limestone", "碎石灰石", Category.DECORATION, MiningTier.NONE),
    ...
    COBBLED_BURNT_LIMESTONE("cobbled_burnt_limestone", "Cobbled Burnt Limestone", "焦灰碎石灰石", Category.DECORATION, MiningTier.NONE),
