...
public final class ModNuclearItems {
    private static final Map<NuclearMaterial, DeferredHolder<Item, Item>> MATERIALS =
            new EnumMap<>(NuclearMaterial.class);
    private static final Map<NuclearFuelGrade, DeferredHolder<Item, FuelAssemblyItem>> FUEL_ASSEMBLIES =
            new EnumMap<>(NuclearFuelGrade.class);
    private static final Map<NuclearControllerUpgrade, DeferredHolder<Item, Item>> CONTROLLER_UPGRADES =
    ...
    public static final DeferredHolder<Item, Item> DOSIMETER = register(
            "dosimeter", () -> new RadiationMeterItem(RadiationMeterItem.Kind.DOSIMETER));
    public static final DeferredHolder<Item, Item> GEIGER_COUNTER = register(
            "geiger_counter", () -> new RadiationMeterItem(RadiationMeterItem.Kind.GEIGER_COUNTER));
    public static final DeferredHolder<Item, Item> SEALED_SPENT_FUEL_CASK = register(
            "sealed_spent_fuel_cask", SealedSpentFuelCaskItem::new);
    public static final DeferredHolder<Item, Item> DECONTAMINATION_KIT = register(
            "decontamination_kit", DecontaminationKitItem::new);
    public static final DeferredHolder<Item, Item> BASIC_RADIATION_HELMET = protection(
            "basic_radiation_helmet", NuclearProtectionMaterial.BASIC, ArmorItem.Type.HELMET, 0.12D);
    public static final DeferredHolder<Item, Item> BASIC_RADIATION_CHESTPLATE = protection(
            "basic_radiation_chestplate", NuclearProtectionMaterial.BASIC, ArmorItem.Type.CHESTPLATE, 0.12D);
    public static final DeferredHolder<Item, Item> BASIC_RADIATION_LEGGINGS = protection(
            "basic_radiation_leggings", NuclearProtectionMaterial.BASIC, ArmorItem.Type.LEGGINGS, 0.12D);
    public static final DeferredHolder<Item, Item> BASIC_RADIATION_BOOTS = protection(
            "basic_radiation_boots", NuclearProtectionMaterial.BASIC, ArmorItem.Type.BOOTS, 0.12D);
    public static final DeferredHolder<Item, Item> HEAVY_RADIATION_HELMET = protection(
            "heavy_radiation_helmet", NuclearProtectionMaterial.HEAVY, ArmorItem.Type.HELMET, 0.33D);
    public static final DeferredHolder<Item, Item> HEAVY_RADIATION_CHESTPLATE = protection(
            "heavy_radiation_chestplate", NuclearProtectionMaterial.HEAVY, ArmorItem.Type.CHESTPLATE, 0.33D);
    public static final DeferredHolder<Item, Item> HEAVY_RADIATION_LEGGINGS = protection(
            "heavy_radiation_leggings", NuclearProtectionMaterial.HEAVY, ArmorItem.Type.LEGGINGS, 0.33D);
    public static final DeferredHolder<Item, Item> HEAVY_RADIATION_BOOTS = protection(
    ...
    static {
        ...
        for (NuclearFuelGrade grade : NuclearFuelGrade.values()) {
            DeferredHolder<Item, FuelAssemblyItem> item = ModRegistries.ITEMS.register(
                    grade.id(),
    ...
    public static DeferredHolder<Item, Item> material(NuclearMaterial material) {
        DeferredHolder<Item, Item> item = MATERIALS.get(material);
        if (item == null) {
    ...
    public static DeferredHolder<Item, FuelAssemblyItem> fuelAssembly(NuclearFuelGrade grade) {
        DeferredHolder<Item, FuelAssemblyItem> item = FUEL_ASSEMBLIES.get(grade);
        if (item == null) {
    ...
    public static Map<NuclearMaterial, DeferredHolder<Item, Item>> materials() {
        return Collections.unmodifiableMap(MATERIALS);
    }

    public static Map<NuclearFuelGrade, DeferredHolder<Item, FuelAssemblyItem>> fuelAssemblies() {
        return Collections.unmodifiableMap(FUEL_ASSEMBLIES);
    }

    public static DeferredHolder<Item, Item> controllerUpgrade(NuclearControllerUpgrade upgrade) {
        DeferredHolder<Item, Item> item = CONTROLLER_UPGRADES.get(upgrade);
        if (item == null) {
    ...
    public static Map<NuclearControllerUpgrade, DeferredHolder<Item, Item>> controllerUpgrades() {
    ...
    private static DeferredHolder<Item, Item> register(String id, java.util.function.Supplier<? extends Item> factory) {
        DeferredHolder<Item, Item> item = ModRegistries.ITEMS.register(id, factory);
        CREATIVE_ITEMS.add(item);
        return item;
    }

    private static DeferredHolder<Item, Item> protection(
