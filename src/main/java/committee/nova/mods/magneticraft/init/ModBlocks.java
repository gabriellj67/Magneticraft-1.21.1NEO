...
public final class ModBlocks {
    private static final Map<BaseBlockDefinition, DeferredHolder<Block, Block>> BLOCKS =
    ...
    static {
        ...
        for (DecorativeBlockFamily family : DecorativeBlockFamily.values()) {
            DeferredHolder<Block, Block> base = family.registersBase()
                    ? registerDecorativeBase(family)
                    : get(Objects.requireNonNull(family.existingBase()));
            DeferredHolder<Block, StairBlock> stairs = ModRegistries.BLOCKS.register(
                    family.stairsId(),
                    () -> new StairBlock(base.get().defaultBlockState(), decorativeProperties(family))
            );
            DeferredHolder<Block, SlabBlock> slab = ModRegistries.BLOCKS.register(
                    family.slabId(),
    ...
    public static DeferredHolder<Block, Block> get(BaseBlockDefinition definition) {
        DeferredHolder<Block, Block> block = BLOCKS.get(definition);
        if (block == null) {
    ...
    public static Map<BaseBlockDefinition, DeferredHolder<Block, Block>> all() {
    ...
    private static DeferredHolder<Block, Block> registerDecorativeBase(DecorativeBlockFamily family) {
        DeferredHolder<Block, Block> block = ModRegistries.BLOCKS.register(
                family.baseId(),
    ...
    public record DecorativeFamilyBlocks(
            DeferredHolder<Block, Block> base,
            DeferredHolder<Block, StairBlock> stairs,
            DeferredHolder<Block, SlabBlock> slab
    ) {
    }
}
