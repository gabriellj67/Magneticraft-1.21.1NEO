...
final class ModRecipeProvider extends RecipeProvider {
    ...
    private void addNuclearFacilityRecipes(RecipeOutput consumer) {
    ...
    private void addNuclearReactorRecipes(RecipeOutput consumer) {
    ...
    private void addNuclearThermalRecipes(RecipeOutput consumer) {
    ...
    private void addNuclearSafetyRecipes(RecipeOutput consumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS,
        ...
        for (int index = 0; index < basicInputs.length; index++) {
            ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, basicOutputs[index])
                    ...
                    .save(consumer, id("crafting/"
                            + BuiltInRegistries.ITEM.getKey(basicOutputs[index].asItem()).getPath()));
        }
        ...
        for (int index = 0; index < heavyInputs.length; index++) {
            ShapelessRecipeBuilder.shapeless(RecipeCategory.COMBAT, heavyOutputs[index])
                    ...
                    .save(consumer, id("crafting/"
                            + BuiltInRegistries.ITEM.getKey(heavyOutputs[index].asItem()).getPath()));
        }
    }
    ...
    private void addAdvancedCraftingRecipes(RecipeOutput consumer) {
    ...
    private void presetFloppy(
        ...
        ShapedRecipeBuilder builder = ShapedRecipeBuilder.shaped(RecipeCategory.MISC, output)
                .define('A', ModComputerContent.FLOPPY_DISK.get())
                .define('B', Tags.Items.DUSTS_REDSTONE)
                .unlockedBy("has_floppy_disk", has(ModComputerContent.FLOPPY_DISK.get()));
        pattern.forEach(builder::pattern);
        builder.save(consumer, id("crafting/floppy_disk_" + preset));
    }

    private void addAdvancedProcessingRecipes(RecipeOutput consumer) {
    ...
    private void advancedProcessing(
        ...
        consumer.accept(
                ...
                new AdvancedProcessingRecipe(machine, input, inputCount, outputs, pressMode, duration, energyPerTick),
                null
        );
    }

    private void addOilProcessingRecipes(RecipeOutput consumer) {
        fluidProcessing(
                consumer,
    ...
    private void fluidProcessing(
        ...
        consumer.accept(
                id("advanced_processing/" + name),
                new AdvancedProcessingRecipe(machine, input, inputAmount, outputs, duration, minimumTemperatureKelvin),
                null
        );
    }

    private static AdvancedProcessingRecipe.FluidInput fluidInput(FluidDefinition definition) {
        ResourceLocation id = Objects.requireNonNull(BuiltInRegistries.FLUID.getKey(ModFluids.get(definition).source().get()));
    ...
    private void addPolymerizingRecipes(RecipeOutput consumer) {
        polymerizing(
                consumer,
                "plastic_sheet",
                Optional.empty(),
    ...
    private void addMachineCraftingRecipes(RecipeOutput consumer) {
    ...
    private void addPortableElectricRecipes(RecipeOutput consumer) {
    ...
    private void addLongDistanceElectricRecipes(RecipeOutput consumer) {
    ...
    private void addTieredBatteryRecipes(RecipeOutput consumer) {
        tieredBattery(
                consumer,
    ...
    private void addTieredCableRecipes(RecipeOutput consumer) {
        tieredLine(
                consumer,
    ...
    private void addTieredConnectorRecipes(RecipeOutput consumer) {
        tieredLine(
                consumer,
    ...
    private void addTieredPoleRecipes(RecipeOutput consumer) {
        tieredLine(
                consumer,
    ...
    private void addTransformerRecipes(RecipeOutput consumer) {
        transformerRecipe(
                consumer,
    ...
    private void addProtectionRecipes(RecipeOutput consumer) {
    ...
    private void addCrushingRecipes(RecipeOutput consumer) {
    ...
    private void addSingleBlockCraftingRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, machine(SingleBlockMachineDefinition.SMALL_TANK))
                ...
                .define('A', Tags.Items.GLASS_BLOCKS).define('B', ModMachineBlocks.GRATE.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, machine(SingleBlockMachineDefinition.WATER_GENERATOR))
                ...
                .define('A', ModTags.Items.lightPlate(Metal.IRON)).define('B', Tags.Items.GLASS_BLOCKS)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, machine(SingleBlockMachineDefinition.AIRLOCK))
                .pattern("ABA").pattern("BCB").pattern("ABA")
                .define('A', Tags.Items.GLASS_BLOCKS).define('B', Items.BUCKET).define('C', ModMachineBlocks.GRATE.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, machine(SingleBlockMachineDefinition.ELECTRIC_ENGINE))
                ...
                .define('A', Tags.Items.INGOTS_COPPER).define('B', Tags.Items.GLASS_BLOCKS)
    ...
    private void automationEndpoint(
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, machine(definition))
                ...
                .define('A', ItemTags.PLANKS).define('B', Tags.Items.COBBLESTONES)
    ...
    private void addSluiceRecipes(RecipeOutput consumer) {
        for (Metal metal : Metal.values()) {
    ...
    private void addNuclearMaterialRecipes(RecipeOutput consumer) {
    ...
    private void addGasificationRecipes(RecipeOutput consumer) {
    ...
    private void addThermopileRecipes(RecipeOutput consumer) {
    ...
    private void addFluidFuelRecipes(RecipeOutput consumer) {
    ...
    private void fluidFuel(RecipeOutput consumer, FluidDefinition definition, int duration, double power) {
    ...
    private void addMaterialConversions(RecipeOutput consumer) {
    ...
    private void addStorageConversions(RecipeOutput consumer) {
        packAndUnpack(
                consumer,
                "lead_block",
    ...
    private void addDecorationRecipes(RecipeOutput consumer) {
    ...
    private void addComponentRecipes(RecipeOutput consumer) {
    ...
    private void addHammerRecipes(RecipeOutput consumer) {
        hammer(consumer, HammerType.STONE, Tags.Items.COBBLESTONES);
        hammer(consumer, HammerType.IRON, Tags.Items.INGOTS_IRON);
        hammer(consumer, HammerType.STEEL, ModTags.Items.ingot(Metal.STEEL));
    }

    private void addSmeltingRecipes(RecipeOutput consumer) {
        ...
        SimpleCookingRecipeBuilder.blasting(
                        ...
                        RecipeCategory.MISC,
                        new ItemStack(ModItems.ingot(Metal.BRASS), 1),
    ...
    private void hammer(RecipeOutput consumer, HammerType type, TagKey<Item> material) {
