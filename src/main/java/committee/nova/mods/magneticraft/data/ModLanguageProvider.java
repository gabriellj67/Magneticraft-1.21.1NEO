...
final class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.magneticraft.electrical.action.reverse_transformer", chinese ? "切换变压器方向" : "Toggle transformer direction");
        add("gui.magneticraft.electrical.action.redstone_mode", chinese ? "切换红石控制模式" : "Cycle redstone control mode");
        add("gui.magneticraft.electrical.action.switch_mode", chinese ? "切换开关红石模式" : "Cycle switch redstone mode");
        add("gui.magneticraft.electrical.action.resistor_ring", chinese ? "调整色环数值" : "Adjust resistor band");
    ...
    private void addClientTranslations() {
        ...
        add("gui.magneticraft.control.current_state", chinese ? "当前：%s" : "Current: %s");
        add("gui.magneticraft.control.enabled", chinese ? "启用" : "Enabled");
        add("gui.magneticraft.control.disabled", chinese ? "禁用" : "Disabled");
        add("gui.magneticraft.inserter.whitelist", chinese ? "切换白名单过滤" : "Toggle whitelist filtering");
        add("gui.magneticraft.inserter.match_damage", chinese ? "匹配耐久值" : "Match durability");
        add("gui.magneticraft.inserter.match_tags", chinese ? "匹配物品标签" : "Match item tags");
        add("gui.magneticraft.inserter.match_nbt", chinese ? "匹配物品数据" : "Match item data");
        add("gui.magneticraft.inserter.allow_stacking", chinese ? "允许物品堆叠" : "Allow item stacking");
        add("gui.magneticraft.inserter.reverse", chinese ? "反转传输方向" : "Reverse transfer direction");
        ...
        add("gui.magneticraft.programmable.upload.tooltip", chinese ? "验证并上传当前程序" : "Validate and upload the current program");
        add("gui.magneticraft.programmable.previous_page", chinese ? "上一页代码" : "Previous source page");
        add("gui.magneticraft.programmable.next_page", chinese ? "下一页代码" : "Next source page");
        add("gui.magneticraft.programmable.language", chinese ? "切换编程语言" : "Cycle programming language");
        ...
        add("gui.magneticraft.guide.cycle_mode", chinese ? "切换指南分类" : "Cycle guide category");
        add("gui.magneticraft.guide.previous_entry", chinese ? "上一个条目" : "Previous entry");
