...
final class MachineRenderHelper {
    ...
    static void renderFluidSurface(
        ...
        vertex(consumer, pose, min, y, min, red, green, blue, alpha,
                sprite.getU0(), sprite.getV0(), light);
        vertex(consumer, pose, min, y, max, red, green, blue, alpha,
                sprite.getU0(), sprite.getV1(), light);
        vertex(consumer, pose, max, y, max, red, green, blue, alpha,
                sprite.getU1(), sprite.getV1(), light);
        vertex(consumer, pose, max, y, min, red, green, blue, alpha,
    ...
    static void renderFluidCuboid(
        ...
        fluidQuad(consumer, pose, packedLight, red, green, blue, alpha,
    ...
    private static void fluidQuad(
        ...
        fluidVertex(consumer, pose, x0, y0, z0, red, green, blue, alpha, u0, v0, light,
                normalX, normalY, normalZ);
        fluidVertex(consumer, pose, x1, y1, z1, red, green, blue, alpha, u0, v1, light,
                normalX, normalY, normalZ);
        fluidVertex(consumer, pose, x2, y2, z2, red, green, blue, alpha, u1, v1, light,
                normalX, normalY, normalZ);
        fluidVertex(consumer, pose, x3, y3, z3, red, green, blue, alpha, u1, v0, light,
                normalX, normalY, normalZ);
    }
