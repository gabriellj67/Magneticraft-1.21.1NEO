...
public final class MagneticraftConfig {
    ...
    public static final ModConfigSpec.BooleanValue CRUSHING_TABLE_CAUSES_FIRE;
    public static final ModConfigSpec.IntValue WATER_GENERATOR_PER_TICK_WATER;
    public static final ModConfigSpec.BooleanValue ENABLE_ELECTRICAL_DAMAGE;
    public static final ModConfigSpec.IntValue ELECTRICAL_RELOAD_GRACE_TICKS;
    public static final ModConfigSpec.BooleanValue ENABLE_NUCLEAR_TERRAIN_DAMAGE;
    public static final ModConfigSpec.DoubleValue NUCLEAR_ACCIDENT_DAMAGE_SCALE;
